function training()
addpath(genpath('.\predict_face'));
%% edit this link
data=xlsread('.\predict_face\training\training.xlsx');
%%
[l br]=size(data);
obs=data(:,1:(br-1));
[r1 c1]=size(obs);
...
normalize=[mini;maxi];
%% edit these links
xlswrite('.\predict_face\predict\theta.xlsx',all_theta);
xlswrite('.\predict_face\predict\normalization_para.xlsx',normalize);
end
